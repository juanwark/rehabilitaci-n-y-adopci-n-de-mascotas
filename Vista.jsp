...
<html>
    ...
    <body class="una">
    <div class="centrada">
        <h2 class="tit">Bienvenido a rehabilitación y adopción de mascotas </h2>
        <h3 class="sec">Fundación de rescate y rehabilitación</h3>
        <div class="ce">
            <h4 class="h">Aqui puedes añadir, eliminar o consultar los gatos y perros  que tenemos para llevar el control de nuestros animales.¿Qué desea hacer? </h4>
        </div>
        ...
        <section id="felino" class="centrada" style="display:none;">
             ...
             <form action="Controlador.jsp" method="POST" >
                ...
                <select name="select" class="botones">
                    <option value="toxo">Libre de toxoplasmosis</option>
                    <option value="noToxo" selected>Con toxoplasmosis</option>
                </select> <br><br>
                <button class="botones" type="submit">
                    <a>Insertar</a>
                </button>
